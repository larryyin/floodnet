...
dir0 = 'img/'
dir1 = 'tests/'
dir2 = 'rmse_compare_feature_y_XLEN/'
...
for ylen in YLEN:
    ...
    #    y_len = int(example['y_len'])
        ...
        RMSE_TEST_TS.append(RMSE_TEST_TS_sub_mean)
    TESTNAME = XYLEN
    ...
    ax.set_title('X:All   Y:{:s}h   All stations   {:s}'.format(ylen,feature),weight='bold')
    fig.tight_layout()
    plotname = 'rmse_compare_{:s}_allx_allstations.png'.format(ylen)
